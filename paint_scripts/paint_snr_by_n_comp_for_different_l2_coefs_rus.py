    ...
    def painter(self,snr_data_dict:dict,
        ...
        for row in range(self.row):
            for col in range(self.col):
                if number==0:
                    ax_name="Регистрация, нм"
                elif number==1:
                    ax_name="Возбуждение, нм"
